<html>
    ...
    <form action="../Controller/alterarFuncionarioController.php" method="post" align="center" name="form">
        ...
        <center><table>
            ...
            <tr>
                <td>CPF(*):</td>
                <td><input type="text" name="cpf" value="<?php echo $funcionario["cpf"] ?>" id="cpf" onchange="valida()" onKeyPress="formata(this, '###.###.###-##')" maxlength="14" readonly="true" required="true" class="txt"></td>
            </tr>
            <tr>
                <td>Data:</td>
            ...
            <tr>
                <?php
                echo "<td>Estado:</td><td><select name='estado' class='txt'>";
                if ($aluno["estado"] == "GO") {
            ...
            <tr>
            <td>Repetir Senha(*):</td><td><input type="text" id="rsenha" name="rsenha" onchange="validaSenha(this);" value="<?php echo $funcionario["senha"] ?>" required="true" class="txt"></td>
    </tr>
    <tr>
        <?php
        $funcionario["perfil_idPerfil"];
        echo "<td>Perfil:</td><td><select name='perfil' required='true' class='txt'>";
